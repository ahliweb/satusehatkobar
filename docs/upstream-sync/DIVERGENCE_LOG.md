...
| 2026-05-23 | `awcmsmicro-dev/templates/awcms-micro-default/`, `awcmsmicro-dev/templates/awcms-sskobar-cloudflare/` | adapt | active | Added recursive public navigation rendering, nested primary menu seeds, and theme-aware shell styling | Keep the public example template aligned with EmDash menus while improving the AWCMS-Micro demo UX | If upstream EmDash gains equivalent template capabilities | OpenCode / GPT-5.4 |
