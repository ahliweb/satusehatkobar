...
- Publish-facing manifest examples use `LicenseRef-AW-NC-1.0`.
- That keeps package metadata aligned with the custom license text.

## Canonical Source

- `https://github.com/ahliweb/aw-non-commercial-license`
