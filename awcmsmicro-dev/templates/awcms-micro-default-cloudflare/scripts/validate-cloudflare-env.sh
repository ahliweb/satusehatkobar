...
require_contains '"name": "awcms-sskkobar-worker"' "$WRANGLER_FILE"
require_contains '"database_name": "awcms-sskkobar-d1"' "$WRANGLER_FILE"
require_contains '"bucket_name": "awcms-sskkobar-r2"' "$WRANGLER_FILE"
