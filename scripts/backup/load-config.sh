...
_load_env_file() {
    ...
    while IFS= read -r raw_line || [ -n "$raw_line" ]; do
        ...
        case "$key" in
            PROJECT_SLUG|WORKSPACE_ENVIRONMENT|LOCAL_SITE_URL|LOCAL_STORAGE_PUBLIC_BASE_URL|PRODUCTION_SITE_URL|PRODUCTION_STORAGE_PUBLIC_BASE_URL|GITLAB_USERNAME|GITLAB_REPO_NAME|GITLAB_PAT|GITLAB_TOKEN|GITHUB_PAT|GITHUB_TOKEN|BACKUP_PASSPHRASE|CLOUDFLARE_API_TOKEN|CLOUDFLARE_ACCOUNT_ID|D1_DATABASE_NAME|R2_BUCKET_NAME|R2_REGION|BACKUP_CRON_SCHEDULE|BACKUP_CONTENT|BACKUP_SSH_KEYS|BACKUP_GPG_KEYS|BACKUP_CLOUD_CREDS|NOTIFICATION_METHOD|GITLAB_REPO_URL|GITLAB_VISIBILITY|GITLAB_SSH_KEY_PATH|GITHUB_REPO_URL|GITHUB_BRANCH|ENCRYPTION_TOOL|LOCAL_BACKUP_DIR|BACKUP_LOG_FILE|GITHUB_ACTION_DEPLOY_WORKFLOW|GITHUB_ACTION_BACKUP_WORKFLOW|GITHUB_ACTION_MIRROR_WORKFLOW|GITHUB_ACTION_DEPLOY_BRANCH|GITHUB_ACTION_BACKUP_CRON|GITHUB_ACTION_WORKER_TEMPLATE_PACKAGE|GITHUB_ACTION_NODE_VERSION|GITHUB_ACTION_PNPM_VERSION|CLOUDFLARE_ZONE_NAME|CLOUDFLARE_DEV_WORKER_NAME|CLOUDFLARE_DEV_WORKER_MAIN|CLOUDFLARE_DEV_COMPATIBILITY_DATE|CLOUDFLARE_DEV_COMPATIBILITY_FLAGS|CLOUDFLARE_DEV_PLACEMENT_MODE|CLOUDFLARE_DEV_ROUTE_PATTERN|CLOUDFLARE_DEV_CUSTOM_DOMAIN|CLOUDFLARE_DEV_OBSERVABILITY|CLOUDFLARE_DEV_D1_BINDING|CLOUDFLARE_DEV_D1_DATABASE_NAME|CLOUDFLARE_DEV_D1_DATABASE_ID|CLOUDFLARE_DEV_R2_BINDING|CLOUDFLARE_DEV_R2_BUCKET_NAME|CLOUDFLARE_DEV_KV_BINDING|CLOUDFLARE_DEV_KV_NAMESPACE_ID|CLOUDFLARE_DEV_IMAGE_BINDING|CLOUDFLARE_DEV_LOADER_BINDING|CLOUDFLARE_WORKER_NAME|CLOUDFLARE_WORKER_MAIN|CLOUDFLARE_WORKER_COMPATIBILITY_DATE|CLOUDFLARE_WORKER_COMPATIBILITY_FLAGS|CLOUDFLARE_WORKER_PLACEMENT_MODE|CLOUDFLARE_WORKER_ROUTE_PATTERN|CLOUDFLARE_WORKER_ZONE_NAME|CLOUDFLARE_WORKER_CUSTOM_DOMAIN|CLOUDFLARE_WORKER_OBSERVABILITY|CLOUDFLARE_WORKER_D1_BINDING|CLOUDFLARE_WORKER_D1_DATABASE_NAME|CLOUDFLARE_WORKER_D1_DATABASE_ID|CLOUDFLARE_WORKER_R2_BINDING|CLOUDFLARE_WORKER_R2_BUCKET_NAME|CLOUDFLARE_WORKER_KV_BINDING|CLOUDFLARE_WORKER_KV_NAMESPACE_ID|CLOUDFLARE_WORKER_IMAGE_BINDING|CLOUDFLARE_WORKER_LOADER_BINDING|CLOUDFLARE_WORKER_SITE_URL|CLOUDFLARE_WORKER_STORAGE_PUBLIC_BASE_URL)
                if [ -z "${!key+x}" ]; then
                    case "$value" in
                        '"'*'"') value="${value:1:-1}" ;;
                        "'"*"'") value="${value:1:-1}" ;;
